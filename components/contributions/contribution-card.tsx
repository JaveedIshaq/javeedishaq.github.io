      ...
      <div>
        <div className="mb-4">
          <h2 className="text-lg font-semibold flex items-center gap-2">
            <Icons.gitBranch size={20} className="text-primary" />
            Open Source Contributions
          </h2>
          <p className="text-sm text-muted-foreground mt-1">
            Pull requests and contributions I have made to external open-source projects
          </p>
        </div>
            ...
            .map((contribution, id) => (
              ...
              >
                <div className="relative rounded-lg border bg-background p-2 hover:bg-accent hover:text-accent-foreground transition-colors w-full h-full flex flex-col">
                  <span className="absolute top-2 right-2 text-[10px] font-medium px-2 py-0.5 rounded-full bg-primary/10 text-primary border border-primary/20">
                    Merged PR
                  </span>
                  <Icons.externalLink
                    size={35}
